package com.caizenghui.parcelableserializable;
...
public class ParcelableSerializableMainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parcelable_serializable_main);
